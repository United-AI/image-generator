...
LATENT_SPACE_DIM = 256  # dimensions of the latent space that is used to generate the images
...
if setup.load_model == True:
    ...
    discriminator = resgenerator.make_net(input_shape=LATENT_SPACE_DIM)
    generator = resdiscrim.make_net(input_shape=[IMAGE_SIZE,IMAGE_SIZE,IMAGE_CHANNELS])
